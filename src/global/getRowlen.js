            ...
            if (isInline) {
                ...
                while (i <= value.length) {
                    ...
                    if (rt != 0) {//rotate
                        ...
                        if (isLineBreak(lastWord) && text_all_split[splitIndex] != null && i != value.length) {                           
                            spaceOrTwoByte = null;
                            anchor = i;
                            ...
                            text_all_split[splitIndex].push({
                                content: preStr,
                                style: fontset,
                                width: preTextWidth*0.9,
                                height: preTextHeight*0.9,
                                left: 0,
                                top: 0,
                                splitIndex: splitIndex,
                                asc: measureText.actualBoundingBoxAscent,
                        ...
                        else if ((width + space_width) > cellWidth && text_all_split[splitIndex] != null && i != value.length) {
